...
public class Midterm2 {
    ...
    public static <T, S, R> List<R> mergeCollections(
        ...
        // Merge elements using the provided function
        for (int i = 0; i < firstArray.length; i++) {
            R mergedElement = mergeFunction.apply(firstArray[i], secondArray[i]);
    ...
    public static <T, S, R> List<R> zipCollections(
        ...
        // Initialize result list with minimum size of both collections
